...
SCPT_DIR="/etc/SCRIPT"
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3RoZW9uZWpwYXMvcHJ1ZWJhLWFsdGVybmEvbWFzdGVyL2dlcmFkb3I="
SUB_DOM='base64 -d'
rm $(pwd)/$0
ofus () {
unset txtofus
...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/theonejpas/prueba-alterna/master/Install/trans &> /dev/null
...
wget https://raw.githubusercontent.com/theonejpas/prueba-alterna/master/gerador/gerar.sh &>/dev/null
